...
# for more information.
$SubscriptionId = "697e3b15-da95-4101-a49d-198676e76111"
$ResourceGroupName = "automation_test_RG"
$StorageAccountName = "utaautomationtest"
$SamAccountName = "utaautomationtest"
...
$OuDistinguishedName = "OU=AZStorage,DC=uta,DC=edu"
