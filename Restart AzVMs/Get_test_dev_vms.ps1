...
{
    Get-AzVM -Name azhwwapt01 -ResourceGroupName utarlingtonautomation-orchestration-testrg
}

function Property_Management_Operating
{
    Get-AzVM -Name assetswapt1 -ResourceGroupName inventorymanagement_test_rg
}

function Enterprise_Development_Admin
{
    Get-AzVM -Name ace-dedwapt01 -ResourceGroupName aceweb_test_rg
}

function Student_Orientation_Programs
{
    Get-AzVM -Name vzenapptst -ResourceGroupName visualzen_test_rg
}

#Start logging
Start-transcript 'C:\get_test_dev_vms.txt'
